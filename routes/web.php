...
Route::middleware(['auth'])->group(function() {
    ...
    Route::middleware(['check.theme'])->group(function() {
        Route::get('/settings/gerenciar-evento/{event}', [EventManegerController::class, 'index'])->name('event.pages');
    ...
    Route::middleware(['check.theme.template'])->group(function() {
        Route::get('/settings/template-pages/{template}', [TemplateController::class, 'index'])->name('template.pages');
