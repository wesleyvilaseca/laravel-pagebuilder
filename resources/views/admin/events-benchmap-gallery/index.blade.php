...
<style>
    ...
    <div class="container-fluid">
        <a href="{{ route('event.benchmap.gallery.create', $event->id) }}" class="btn btn-primary btn-sm">Adicionar imagem</a>
            ...
            <tbody>
                @forelse ($gallery as $banner)
                    <tr>
                        ...
                        <td> 
                            @php
                                $image = $banner->uploads()->wherePivot('alias_category', 'event-benchmap-gallery')->first();    
                            @endphp
                        ...
                        <td style="width=10px;">
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                  <a class="dropdown-item" href="{{ route('event.benchmap.gallery.edit', [$event->id, $banner->id]) }}">
                                    <i class="fas fa-edit text-primary"></i> Editar
                                  </a>
                                  <a class="dropdown-item" href="{{ route('event.benchmap.gallery.show', [$event->id, $banner->id]) }}">
